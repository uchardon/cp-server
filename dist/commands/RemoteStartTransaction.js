...
var _RemoteStartTransaction = _interopRequireDefault(require("../../ocpp-1.6-schemas/RemoteStartTransaction"));

var _RemoteStartTransactionResponse = _interopRequireDefault(require("../../ocpp-1.6-schemas/RemoteStartTransactionResponse"));
...
class RemoteStartTransaction extends _BaseCommand.default {
  constructor(values) {
    super(_RemoteStartTransaction.default, _RemoteStartTransactionResponse.default, values);
  }

}

exports.RemoteStartTransaction = RemoteStartTransaction;